...
export const RESOLVERS: Record<string, ResolverFn> = {
  ...
  OUTSIDE_INVOCATION: (ctx, args) => outsideVoiceInvocation(ctx, { timeoutMs: args?.[0] === 'spec' ? 120000 : 600000, gate: args?.[0] === 'spec' ? 'spec' : 'review', reasoningEffort: 'medium', voice: args?.[0] === 'spec' ? 'spec' : args?.[0] === 'autoplan' ? 'autoplan' : 'outside-review' }),
